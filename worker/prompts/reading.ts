...
- 각 cards[].reading은 2문장 중심으로 간결하게 작성한다. 3문장을 넘기지 마라.
  ...
  "cards": [
    {
      ...
      "name": "카드 영문명",
      "koreanName": "카드 한글명",
      "reading": "위치 의미 + 카드 상징 + 사용자 질문 연결 + 현실 조언이 담긴 짧은 해석. 카드의 일반 의미만 말하지 말 것."
    }
  ],
